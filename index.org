...
Below are results from a Markov-Switching CAPM regression with 2 regimes.  $^{*}$, $^{**}$, and $^{***}$ denote significance at the 10%, 5%, and 1% levels respectively.

Table 1 shows coefficients from the low volatility regime.
